...
#if CONFIG_BMI270_PLUS_TRIGGER_OWN_THREAD
	struct k_sem trig_sem;

	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_BMI270_PLUS_THREAD_STACK_SIZE);
	struct k_thread thread;

#elif CONFIG_BMI270_PLUS_TRIGGER_GLOBAL_THREAD
...
union bmi270_bus {
#if CONFIG_BMI270_PLUS_BUS_SPI
	struct spi_dt_spec spi;
#endif
#if CONFIG_BMI270_PLUS_BUS_I2C
